...
| 06  | ✔️     | ✔️     | 7 ms      | Seems to be redundant this year, first part was very simple but it was really difficult to find a way to use what was done for the first part to the second part. **Note : IntelliJ seems to trim the last blank space at the end of a txt file. So, you need to manually add a space if needed at the end of the file to get it to work fine.**|
| 07  | ❌      | ❌      | —         |                                                                                                                                                                                                                          |
| 08  | ❌      | ❌      | —         |                                                                                                                                                                                                                          |
| 09  | ❌      | ❌      | —         |                                                                                                                                                                                                                          |
| 10  | ❌      | ❌      | —         |                                                                                                                                                                                                                          |
