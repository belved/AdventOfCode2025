...
| 06  | ✔️     | ✔️     | 7 ms      | Seems to be redundant this year, first part was very simple but it was really difficult to find a way to use what was done for the first part to the second part.                                                        |
| 07  | ❌      | ❌      | —         |                                                                                                                                                                                                                          |
| 08  | ❌      | ❌      | —         |                                                                                                                                                                                                                          |
| 09  | ❌      | ❌      | —         |                                                                                                                                                                                                                          |
| 10  | ❌      | ❌      | —         |                                                                                                                                                                                                                          |
